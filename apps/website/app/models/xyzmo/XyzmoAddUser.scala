...
class XyzmoAddUserStore @Inject()(schema: Schema) extends SavesWithLongKey[XyzmoAddUser] with SavesCreatedUpdated[Long,XyzmoAddUser] {
  ...
  //
  // SavesCreatedUpdated[Long,XyzmoAddUser] methods
  //
