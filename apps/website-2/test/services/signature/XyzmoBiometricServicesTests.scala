  ...
  with DBTransactionPerTest
{
  ...
  "getSignatureDataContainerFromJSON" should "translate JSON signature to Xyzmo SignatureDataContainer" in new TestApplication {
  ...
  "getUserId" should "prepend _userIdPrefix" in new TestApplication {
  ...
  "XyzmoTestBiometricServices" should "test end-to-end" in new TestApplication {
