      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var user = '<a class="tweet-user" href="'+user_url+'">'+screen_name+'</a>';
            var join = ((s.join_text) ? ('<span class="tweet-join"> '+join_text+' </span>') : ' ');
            var avatar = (avatar_size ?
                          ('<a class="tweet-avatar" href="'+user_url+'"><img src="'+avatar_url+
                           '" height="'+avatar_size+'" width="'+avatar_size+
                           '" alt="'+screen_name+'\'s avatar" title="'+screen_name+'\'s avatar" /></a>') : '');
            var time = '<span class="tweet-time"><em><a href="'+tweet_url+'" title="view tweet on twitter">'+tweet_relative_time+'</a></em></span>';
            var text = '<span class="tweet-text">'+$([tweet_text]).makeHeart().capAwesome().capEpic()[0]+ '</span>';
          ...
          list.append($.map(tweets,
              ...
              children('li:last').addClass('tweet-last').end().
