...
object ApplicationBuild extends Build {
  ...
  val appName = "website-dal"
  val appVersion = "1.0-SNAPSHOT"

  val appDependencies = Seq(
    //TODO: trim these down, not all are used
  ...
  val main = PlayProject(appName, appVersion, appDependencies).settings( // Add your own project settings here
