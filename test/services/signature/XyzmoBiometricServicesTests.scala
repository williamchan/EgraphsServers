...
//    deleteUserResponse.getBaseResult should be("ok")
...
//    addUserResponse.getBaseResult should be("ok")
...
//    addProfileResponse.getBaseResult should be("ok")
...
//    enrollUserResponse.getBaseResult should be("ok")
//    enrollUserResponse.getError should be(None)
//    enrollUserResponse.getErrorMsg should be(None)
//    enrollUserResponse.getEnrollResult.get should be("EnrollCompleted")
...
//    //    verifyUserResponse_Match.getBaseResult should be("ok")
...
//    //    verifyUserResponse_Match.getScore.get should be(100)
//    println("verifyUserResponse_Match = " + verifyUserResponse_Match)
//
//    val verifyUserResponse_NoMatch: XyzmoVerifyUserResponse = XyzmoBiometricServices.verifyUser(userId, signature_nomatch)
//    //    verifyUserResponse_Match.getBaseResult should be("ok")
//    //    verifyUserResponse_Match.getError should be(None)
//    //    verifyUserResponse_Match.getErrorMsg should be(None)
//    //    verifyUserResponse_Match.isMatch should be (false)
//    //    verifyUserResponse_Match.getScore.get should be(100)0
//    println("verifyUserResponse_NoMatch = " + verifyUserResponse_NoMatch)
//  }
}
