...
trait FilterThreeTables[T1, T2, T3] extends FilterSomeTables[T1, T2, T3, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing] {
...
object FilterThreeTables {
  def reduceFilters[T, U, V](filters: Iterable[FilterThreeTables[T, U, V]], t1: T, t2: U, t3: V) = {
    FilterSomeTables.reduceFilters(filters, t1, Some(t2), Some(t3))
  }
}

trait FilterTwoTables[T1, T2] extends FilterSomeTables[T1, T2, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing] {
...
object FilterTwoTables {
  def reduceFilters[T1, T2](filters: Iterable[FilterTwoTables[T1, T2]], t1: T1, t2: T2): LogicalBoolean = {
    FilterSomeTables.reduceFilters(filters, t1, Some(t2))
  }
}


trait FilterSomeTables[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10] {
  def test(t1: T1,
           t2: Option[T2],
           t3: Option[T3],
           t4: Option[T4],
...
object FilterSomeTables {
  def reduceFilters[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10] (
    filters: Iterable[FilterSomeTables[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]],
    t1: T1,
    t2: Option[T2] = None,
    t3: Option[T3] = None,
    t4: Option[T4] = None,
